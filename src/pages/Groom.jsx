    ...
    <>
      ...
      <section className="relative h-[50vh] md:h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <a
            href="https://wa.me/919302154692?text=Hi%20I%20want%20to%20book%20groom%20mehendi"
            target="_blank"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Modern Designs</h3>
              <p className="text-gray-600">Trendy groom mehendi designs with personalized initials and wedding motifs</p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-3xl">✨</span>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Quick & Stylish</h3>
              <p className="text-gray-600">Get the perfect groom look in just 30-60 minutes with our expert application</p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-3xl">📍</span>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">At Your Location</h3>
              <p className="text-gray-600">We come to your venue, home, or hotel for a convenient groom mehendi session</p>
            </div>
          </div>

          {/* Price Range */}
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 text-center mb-16">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Groom Mehendi Packages</h2>
            <div className="flex items-baseline justify-center gap-2 mb-4">
              <span className="text-5xl font-extrabold text-primary">₹500</span>
              <span className="text-2xl text-gray-400">–</span>
              <span className="text-5xl font-extrabold text-primary">₹2,000</span>
            </div>
            <p className="text-gray-500 mb-6">Depends on design complexity and hand/arm coverage</p>
            <div className="w-20 h-1 bg-secondary rounded-full mx-auto"></div>
          </div>

          {/* Designs */}
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">
            Groom Design Collection
      ...
      <section className="bg-primary py-16 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Complete the Groom Look!
          </h2>
          <p className="text-white/80 mb-8 text-lg">
            A groom isn't complete without mehendi. Book your session and match your bride's elegance
          </p>
