        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-6 bg-[#3d0505]/40 backdrop-blur-sm rounded-2xl border border-secondary/10 hover:border-secondary transition-all">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Baby Themed Designs</h3>
              <p className="text-white/60">Adorable baby motifs, cradles, tiny footprints and cute patterns for the mom-to-be</p>
            </div>
            <div className="text-center p-6 bg-[#3d0505]/40 backdrop-blur-sm rounded-2xl border border-secondary/10 hover:border-secondary transition-all">
              <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mx-auto mb-4 border border-secondary/20">
                <span className="text-3xl text-secondary">🌸</span>
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Godh Bharai Special</h3>
              <p className="text-white/60">Traditional godh bharai mehendi with auspicious symbols and floral patterns</p>
            </div>
            <div className="text-center p-6 bg-[#3d0505]/40 backdrop-blur-sm rounded-2xl border border-secondary/10 hover:border-secondary transition-all">
              <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mx-auto mb-4 border border-secondary/20">
                <span className="text-3xl text-secondary">👨‍👩‍👧</span>
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Family Packages</h3>
              <p className="text-white/60">Special packages for the mom-to-be and family members attending the celebration</p>
            </div>
          </div>
          ...
          <div className="bg-[#3d0505]/60 backdrop-blur-md rounded-3xl p-8 md:p-12 shadow-2xl border border-secondary/20 text-center mb-16 relative overflow-hidden group">
            ...
            <h2 className="text-2xl font-bold text-white mb-6 tracking-wide">Baby Shower Mehendi Packages</h2>
            ...
            <div className="flex justify-center items-center gap-6 sm:gap-12 mb-8 relative">
              <div className="text-center">
                ...
                <p className="text-3xl sm:text-5xl font-extrabold text-white">₹300</p>
              </div>
              <div className="h-16 w-px bg-gradient-to-b from-transparent via-secondary/30 to-transparent"></div>
              <div className="text-center">
                <p className="text-secondary/60 text-[10px] sm:text-xs uppercase tracking-[0.2em] mb-2">Full Packages</p>
                <p className="text-3xl sm:text-5xl font-extrabold text-white">₹1,500</p>
              </div>
            </div>
            
            <p className="text-white/60 mb-6 max-w-sm mx-auto">Simple to detailed designs for the expecting mother and guests</p>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-10 tracking-tight">
            Baby Shower Design <span className="gold-shimmer font-cursive text-5xl">Collection</span>
      ...
      <section className="bg-maroon-pattern py-20 px-6 text-center border-t border-secondary/10 relative overflow-hidden">
        <div className="max-w-3xl mx-auto relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            Ready to <span className="gold-shimmer">Celebrate</span> Joy?
          </h2>
          <p className="text-white/60 mb-10 text-lg leading-relaxed max-w-2xl mx-auto">
            Make your baby shower celebration extra special with beautiful mehendi for the mom-to-be and family. Professional home service.
          </p>
